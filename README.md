...
Included in this repository is a presentation (https://github.com/clouducate/awsvpcb/blob/main/Clouducate.pdf) which explains and provides an introduction to AWSVPCB and Havoc Circus and the awsvpcb-setup script with instructions (https://github.com/clouducate/awsvpcb/raw/refs/heads/main/awsvpcb-setup%20instructions.docx) which allows for professors to use the scripts "as is" while still getting support from a central administrator.  The rest of this document will focus on AWSVPCB.
#
#
#
...
ServerPrivateKey (required): Defines the private key file (included in the secfiles directory) to use for the servers.
#
#
#
